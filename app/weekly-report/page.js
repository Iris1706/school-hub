                        ...
                        {irisPerson && (
                          (() => {
                            const getEventColor = (event) => {
                              ...
                              const colorMap = {
                                '三多': { bgColor: '#9fbc5f', textColor: '#ffffff' },
                                '外出': { bgColor: '#c696d4', textColor: '#ffffff' },
                                '上午(外)': { bgColor: '#8ab3bd', textColor: '#ffffff' },
                                '下午(外)': { bgColor: '#e89a87', textColor: '#ffffff' },
                                '特休': { bgColor: '#a02a42', textColor: '#ffffff' },
                                '排休': { bgColor: '#d4b855', textColor: '#ffffff' },
                                '巡檢': { bgColor: '#7db5d8', textColor: '#ffffff' },
                                '上午(巡)': { bgColor: '#432056', textColor: '#ffffff' },
                                '下午(巡)': { bgColor: '#432056', textColor: '#ffffff' },
                                '國定假日': { bgColor: '#a61473', textColor: '#ffffff' },
                                '彈性假': { bgColor: '#7a7f88', textColor: '#ffffff' },
                                '病假': { bgColor: '#4d6a9f', textColor: '#ffffff' },
                                '事假': { bgColor: '#8a8585', textColor: '#ffffff' },
                                '駐點': { bgColor: '#b86618', textColor: '#ffffff' },
                                '上午(特)': { bgColor: '#800101', textColor: '#ffffff' },
                                '下午(特)': { bgColor: '#800101', textColor: '#ffffff' },
                                '颱風假': { bgColor: '#184252', textColor: '#ffffff' },
                              };
