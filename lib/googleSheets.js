...
export const INSPECT_SHEET_ID = process.env.Inspect_SHEET_ID;
export const SCHOOL_INFO_TAB = "學校資訊";
export const HISTORY_TAB = "修改紀錄";
export const TODO_TAB = "待辦";
export const INSPECT_TAB = "2026下半年高雄市生生平板巡檢總表";
